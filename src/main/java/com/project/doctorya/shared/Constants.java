...
public class Constants {
    ...
    public static String authNotFound = "Auth not found";
    public static String authExists = "Auth already exists";
    public static String credentialsNotValid = "Credentials not valid";
    public static String accessDenied = "Access denied insufficient permissions";
}
